...
export class ContainerInstance {
  ...
  get<T>(identifier: ServiceIdentifier<T>): T {
    ...
    if (service && this !== globalContainer) {
      ...
      return this.getServiceValue(identifier, clonedService, true);
    }
  ...
  set(
    ...
    const service = this.findService(newService.id as any);
   ...
   */
  private initializeParams(type: Function | undefined, paramTypes: any[]): any[] {
  ...
  private applyPropertyHandlers(target: Function, instance: { [key: string]: any }) {
    Container.handlers.forEach(handler => {
      ...
      instance[handler.propertyName as string] = handler.value(this);
    });
  }
}
